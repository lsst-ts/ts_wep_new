...
* **EstimateZernikesTaskConnections**: Connections setup for EstimateZernikesTask to run in a pipeline with Gen 3 middleware.
* **EstimateZernikesTaskConfig**: Configuration setup for EstimateZernikesTask.
* **EstimateZernikesTask**: Gen 3 middleware task to take exposures and donut source catalogs and calculate Zenikes coefficients for each CCD. Saves Zernike coefficients and associated DonutStamps to Gen 3 repository.
